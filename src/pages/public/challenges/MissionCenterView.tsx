...
import "./MissionCenterView.css";

// Assets
import aiCoinImg from "@/assets/images/coin-gold.png";
import specialCoinImg from "@/assets/images/coin.png";
...
export const MissionCenterView = React.forwardRef<
  HTMLDivElement,
  { onBack: () => void }
>(({ onBack }, ref) => {
    ...
    >
      <div className="mc-top-banner">
        ...
        <div className="mc-hero-title">
          <img src={chestEpic} alt="Chest" className="mc-hero-icon" />
          <h1>MISSION CENTER</h1>
          <p>
            Open chests • Get awesome rewards • Make your journey even more
            special!
          </p>
        </div>
      </div>
            ...
            >
              ...
              <div className="mission-history-filters">
                <div className="filter-tabs">
                  {["All", "Completed", "In Progress", "Missed"].map((tab) => (
                    <button
                      key={tab}
              ...
              <div className="mission-history-list">
                {MOCK_HISTORY.map((item) => (
                  <div key={item.id} className="mission-history-row">
                    ...
                    <div className="mission-history-row__date">{item.date}</div>
                    <div
